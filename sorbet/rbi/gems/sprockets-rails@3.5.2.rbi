...
class Rails::Application < ::Rails::Engine
  # source://railties/7.2.1/lib/rails/application.rb#108
  ...
  # source://railties/7.2.1/lib/rails/application.rb#101
  def autoloaders; end

  # source://railties/7.2.1/lib/rails/engine.rb#516
  def build_middleware_stack; end

  # source://railties/7.2.1/lib/rails/application.rb#446
  def config; end

  # source://railties/7.2.1/lib/rails/application.rb#450
  def config=(_arg0); end

  # source://railties/7.2.1/lib/rails/application.rb#283
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.2.1/lib/rails/application.rb#366
  def console(&blk); end

  # source://railties/7.2.1/lib/rails/application.rb#487
  def credentials; end

  # source://railties/7.2.1/lib/rails/application.rb#451
  def credentials=(_arg0); end

  # source://railties/7.2.1/lib/rails/application.rb#103
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.1/lib/rails/application.rb#103
  def default_url_options=(arg); end

  # source://railties/7.2.1/lib/rails/application.rb#239
  def deprecators; end

  # source://railties/7.2.1/lib/rails/application.rb#545
  def eager_load!; end

  # source://railties/7.2.1/lib/rails/application.rb#506
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.2.1/lib/rails/application.rb#312
  def env_config; end

  # source://railties/7.2.1/lib/rails/application.rb#101
  def executor; end

  # source://railties/7.2.1/lib/rails/application.rb#372
  def generators(&blk); end

  # source://railties/7.2.1/lib/rails/application.rb#519
  ...
  # source://railties/7.2.1/lib/rails/application.rb#433
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.2.1/lib/rails/application.rb#133
  def initialized?; end

  # source://railties/7.2.1/lib/rails/application.rb#354
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.2.1/lib/rails/application.rb#440
  def initializers; end

  # source://railties/7.2.1/lib/rails/application.rb#383
  def isolate_namespace(mod); end

  # source://railties/7.2.1/lib/rails/application.rb#167
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/7.2.1/lib/rails/application.rb#539
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.2.1/lib/rails/application.rb#231
  def message_verifier(verifier_name); end

  # source://railties/7.2.1/lib/rails/application.rb#203
  def message_verifiers; end

  # source://railties/7.2.1/lib/rails/application.rb#535
  def migration_railties; end

  # source://railties/7.2.1/lib/rails/application.rb#140
  def name; end
  ...
  # source://railties/7.2.1/lib/rails/application.rb#347
  def rake_tasks(&block); end

  # source://railties/7.2.1/lib/rails/application.rb#159
  ...
  # source://railties/7.2.1/lib/rails/application.rb#409
  def require_environment!; end

  # source://railties/7.2.1/lib/rails/application.rb#414
  def routes_reloader; end

  # source://railties/7.2.1/lib/rails/application.rb#144
  def run_load_hooks!; end

  # source://railties/7.2.1/lib/rails/application.rb#360
  def runner(&blk); end

  # source://railties/7.2.1/lib/rails/application.rb#99
  def sandbox; end
  ...
  # source://railties/7.2.1/lib/rails/application.rb#469
  def secret_key_base; end

  # source://railties/7.2.1/lib/rails/application.rb#378
  def server(&blk); end

  # source://railties/7.2.1/lib/rails/application.rb#515
  def to_app; end

  # source://railties/7.2.1/lib/rails/application.rb#421
  def watchable_args; end

  protected

  # source://railties/7.2.1/lib/rails/application.rb#618
  def default_middleware_stack; end

  # source://railties/7.2.1/lib/rails/application.rb#623
  def ensure_generator_templates_added; end

  # source://railties/7.2.1/lib/rails/application.rb#584
  def ordered_railties; end

  # source://railties/7.2.1/lib/rails/application.rb#606
  def railties_initializers(current); end

  # source://railties/7.2.1/lib/rails/application.rb#573
  def run_console_blocks(app); end

  # source://railties/7.2.1/lib/rails/application.rb#563
  def run_generators_blocks(app); end

  # source://railties/7.2.1/lib/rails/application.rb#568
  def run_runner_blocks(app); end

  # source://railties/7.2.1/lib/rails/application.rb#578
  def run_server_blocks(app); end

  # source://railties/7.2.1/lib/rails/application.rb#552
  def run_tasks_blocks(app); end

  private

  # source://railties/7.2.1/lib/rails/application.rb#636
  def build_middleware; end

  # source://railties/7.2.1/lib/rails/application.rb#629
  def build_request(env); end

  # source://railties/7.2.1/lib/rails/application.rb#640
  def coerce_same_site_protection(protection); end

  # source://railties/7.2.1/lib/rails/application.rb#644
  def filter_parameters; end

  class << self
    # source://railties/7.2.1/lib/rails/application.rb#402
    def add_lib_to_load_path!(root); end

    # source://railties/7.2.1/lib/rails/application.rb#83
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.2.1/lib/rails/application.rb#87
    def find_root(from); end

    # source://railties/7.2.1/lib/rails/application.rb#70
    def inherited(base); end

    # source://railties/7.2.1/lib/rails/application.rb#79
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/7.2.1/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#14
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#558
  def annotations; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#373
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#468
  def autoload_lib(ignore:); end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#480
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#385
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#492
  def colorize_logging; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#496
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#563
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#431
  def database_configuration; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#387
  def debug_exception_response_format; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#391
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#580
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#349
  def enable_reloading; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#353
  def enable_reloading=(value); end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#365
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#592
  def inspect; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#413
  def load_database_yaml; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#91
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#380
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#393
  def paths; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#572
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#357
  def read_encrypted_secrets; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#361
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#345
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#501
  def secret_key_base; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#511
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#538
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#554
  ...
  # source://railties/7.2.1/lib/rails/application/configuration.rb#619
  def credentials_defaults; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#629
  def generate_local_secret; end

  # source://railties/7.2.1/lib/rails/application/configuration.rb#641
  def generate_local_secret?; end
end
